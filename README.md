...
A proposta do projeto é criar um programa que leia e analise grandes massas de dados do cadastro positivo (por conta da mudança do mesmo) e exiba na tela um relatório de erros (e arrume-os, se possível), além de indicadores de negócios.
